...
# Стандартные значения атаки, защиты, выносливости
DEFAULT_ATTACK = 5
DEFAULT_DEFENCE = 10
DEFAULT_STAMINA = 80
...
class Character:
    ...
    # Константа для диапазона очков урона и защиты.
    RANGE_VALUE_ATTACK = (1, 3)
    RANGE_VALUE_DEFENCE = (1, 5)
    # Константы для спец.умений очки урона и имя
    SPECIAL_BUFF = 15
    SPECIAL_SKILL = 'Удача'
...
class Warrior(Character):
    ...
    # Константы для спец.умений очки эффекта и имя
